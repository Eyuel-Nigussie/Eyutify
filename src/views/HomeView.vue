...
<template>
    <div class="p-8">
        ...
        <div class="flex items-center">
            ...
            <HomeCard image="https://picsum.photos/id/44/300/300" title="Title is here" subTitle="Subtitle is here" />
            <HomeCard class="md:block hidden" image="https://picsum.photos/id/19/300/300" title="Title is here" subTitle="Subtitle is here" />
            <HomeCard class="lg:block hidden" image="https://picsum.photos/id/17/300/300" title="Title is here" subTitle="Subtitle is here" />
            <HomeCard class="xl:block hidden" image="https://picsum.photos/id/200/300/300" title="Title is here" subTitle="Subtitle is here" />
        </div>
    </div>
    ...
    <div class="p-8">
        ...
        <div class="flex items-center">
            ...
            <HomeCard class="lg:block hidden" image="https://picsum.photos/id/214/300/300" title="Title is here" subTitle="Subtitle is here" />
    ...
    <div class="p-8">
        ...
        <div class="flex items-center">
            ...
            <HomeCard class="md:block hidden" image="https://picsum.photos/id/70/300/300" title="Title is here" subTitle="Subtitle is here" />
            <HomeCard class="lg:block hidden" image="https://picsum.photos/id/122/300/300" title="Title is here" subTitle="Subtitle is here" />
